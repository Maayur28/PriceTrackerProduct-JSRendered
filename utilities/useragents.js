const userAgentList = [
  ...
  "Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_5_6; en-US) AppleWebKit/530.5 (KHTML, like Gecko) Chrome/ Safari/530.5", //Google
...
const maxLimit = userAgentList.length;
const getUserAgents = () => {
  let rand = Math.floor(Math.random() * maxLimit);
  return userAgentList[rand];
};
